...
function user_register_post_types()
{
    ...
    $user_magic_post_type_maker_array = array(
        array(
            ...
            'supports' => array('title', 'page-attributes', 'thumbnail', 'author')
        )
    );
    ...
    foreach ($user_magic_post_type_maker_array as $post_type) {
        ...
        // Arguments
        $args = user_generate_post_type_args($labels, $cpt_plural, $cpt_icon, $exclude_from_search, $supports);
...
function user_generate_post_type_args($labels, $cpt_plural, $cpt_icon, $exclude_from_search, $supports)
{
    $args = array(
        'labels'              => $labels,
...
function reorder_admin_menu($__return_true)
{
    return array(
        ...
        'edit.php', // Posts
        'edit.php?post_type=gallery', // Pages
        'upload.php', // Media
